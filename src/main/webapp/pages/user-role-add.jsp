...
<script>
    ...
    function addRoles() {
        ...
        $.ajax({
            type: "post",
            url: "${pageContext.request.contextPath}/users/addRole.do",
            data: {roleList: roleList.toString(), userName: userName},
            success: function () {
                alert("添加角色成功");
                location.href = "${pageContext.request.contextPath}/users/findAll02.do";
            },
            error: function () {
                alert("添加角色失败");
            }
